...
#define COMMIT_ID_NON_BRANCH_BYTES (COMMIT_ID_SIZE - COMMIT_ID_BRANCH_BYTES)
...
const char FIRST_COMMIT_ID[COMMIT_ID_NON_BRANCH_BYTES] = "111111111111111111111111111111";
